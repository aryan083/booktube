      ...
      <nav className="fixed top-0 left-0 w-full bg-transparent bg-opacity-0 backdrop-blur-3xl p-4 z-10" style={{ zIndex: 10 }}>
        <div className="container mx-auto flex flex-col sm:grid sm:grid-cols-3 items-center w-full">
          ...
          <div className="flex items-center w-full sm:w-auto justify-between">
            ...
            <button className="sm:hidden bg-transparent text-white focus:outline-none" onClick={() => setShowMobileMenu(!showMobileMenu)}>
          ...
          {showMobileMenu && (
            <div className="sm:hidden w-full mt-4 flex flex-col items-center space-y-4 bg-black bg-opacity-90 rounded-lg p-4">
              <a href="#features" className="text-white hover:text-cyan-300 transition-colors w-full text-center">Features</a>
              <a href="#testimonials" className="text-white hover:text-cyan-300 transition-colors w-full text-center">Testimonials</a>
              <a href="#pricing" className="text-white hover:text-cyan-300 transition-colors w-full text-center">Pricing</a>
              <a href="#team" className="text-white hover:text-cyan-300 transition-colors w-full text-center">Team</a>
              <Link to="/SignIn" className="w-full text-center">
                <Button className="bg-transparent text-white shadow-none border-none px-4 py-2 transition-colors hover:text-cyan-300 w-full" style={{ background: 'transparent' }}>Login</Button>
              </Link>
...
{     !isMobile ?     (<p className={`font-bold text-white text-center break-words ${isMobile ? 'text-2xl xs:text-3xl' : 'text-4xl xs:text-5xl sm:text-6xl md:text-8xl'}`}>
            Learning but,
          </p>): null}
          {isMobile ? (
            <div className="flex flex-col items-center font-bold text-white mt-4 w-full">
              <span className="block text-2xl xs:text-3xl text-center w-full">Learning but,</span>
              <span className="block text-2xl xs:text-3xl text-center w-full mt-1">Make it</span>
