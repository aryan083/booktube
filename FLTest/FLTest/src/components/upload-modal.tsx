...
const UploadModal: React.FC<UploadModalProps> = ({ isOpen, onClose, onUpload, onNext }) => {
        ...
        <div className="relative w-full max-w-2xl h-[550px] bg-black border border-gray-700 rounded-xl shadow-lg overflow-y-auto">
          ...
          <div className="flex justify-end items-center gap-x-2 py-3 px-4 border-t border-gray-700">
            ...
            <button
              ...
              className="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-gray-700 text-white hover:bg-gray-600 disabled:opacity-50 disabled:pointer-events-none"
            >
              Next
            </button>
          </div>
