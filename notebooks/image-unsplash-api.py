...
def search_image(query):
    ...
    if data['data']:
        print(data)
        return data['data'][0]['assets']['preview_1500']['url']
    else:
...
article_id = "02c23421-1696-4659-9cdc-53ba14a43f99"
content = unsplash_api_fetcher(article_id)
